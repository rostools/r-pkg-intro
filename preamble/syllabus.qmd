...
or resources for researchers that focuses on the inbetween: Building
...
> and to create a simple R package that can be installed on their own
> (or a colleagues') computer.
...
like you in mind as the type of people who would be interested in and
