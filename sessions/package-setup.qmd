...
1.  Describe how an R package looks like and create a basic package
...
1.  Describe what a basic R package "physically" looks like, what the
    required files and folders, and what their purpose is.
2.  Use the `{usethis}` and `{devtools}` packages to create a basic R
    package.
...
4.  List the different locations data can be stored in a package and
    ...
    to create and store data to the relevant location.
