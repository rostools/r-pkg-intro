...
-   Explain what *formal testing* means when developing packages, 
    describe how they are structured, and construct simple tests of 
    functions. 

More specific objectives are to:
-   Add formal tests of a package function using `testthat`
-   Describe an expectation using an `expect_xxx()` function
-   Run all the tests for a file in `R/`
-   Implement a workflow to validate an R package locally
-   Explain what CRAN is and conduct CRAN checks
...
-   Adding formal tests to your package
    ...
    -   Text: How do we know our code is correct? So far, informal
        ...
        output. Formal testing automates this + ensures that when you further develop your code, your code still works as you expect it to 
