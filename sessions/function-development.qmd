...
- Explain some software development and functional programming principles that underlie effective R package development
-   Review and apply the workflow for converting code into a function.
-   Identify approaches and "code patterns" for writing your functions that ensure they are internally self-contained and reusable
-   Explain what dependency means in the context of packages and how you formally manage dependencies when writing functions as part of a package
-   Use control flow processes like `if else` to change what a function does based on a condition.
