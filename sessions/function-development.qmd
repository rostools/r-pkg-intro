...
-   Convert your R code into a function
-   Make your function modular and reusable
-   Understand dependecy management and use functions from other
    packages in your own package
-   Learn and use process control to return error messages from a
    function
