...
that gap and covers the fundamentals and workflow of building an R
package.
...
page](https://r-pkg-intro.rostools.org/).

## Instructional Design

The lectures and lessons in this course and educational resource are
designed to be presented primarily with a participatory live-coding
approach. This involves an instructor typing and running code in
